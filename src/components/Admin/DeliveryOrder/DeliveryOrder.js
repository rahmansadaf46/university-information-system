...
const DeliveryOrder = () => {
   ...
   useEffect(() => {
    ...
    for (let i = 0; i < item.length; i++) {
        total.push(Number(item[i].finalData.amount));
    }
    ...
    return (
        <div>
            ...
            <div className="d-flex">
                ...
                {
                    item.length === 0 ? <div style={{ backgroundColor: '#FEF78D', height: '800px' }} className="col-md-10 pt-4 d-flex justify-content-center"><h2 className="text-primary">Loading...</h2></div> : <div style={{ backgroundColor: '#FEF78D', height: '100%', minHeight: '800px' }} className="col-md-10 pt-4 d-flex justify-content-center">
                        <div className="">
                            ...
                            <div>
                               ...
                               <div className="text-center "style={{width: '550px', height: '100%', border: '4px solid blue', borderRadius: '30px', backgroundColor: '#F0FFEF', marginBottom: '25px', padding: '30px'}}>
                               ...
                               <div className="text-center "style={{width: '550px', height: '100%', border: '4px solid blue', borderRadius: '30px', backgroundColor: '#F0FFEF', marginBottom: '25px', padding: '30px'}}>
                                ...
                                {
                                    item.map(fd => <div className="d-flex justify-content-center">
                                        ...
                                        <br />
                                        {fd.finalData.cart.map(item => <p style={{ fontSize: '18px' }}><span className="font-weight-bold text-primary">{item.title}</span> <span className="font-weight-bold text-dark">: {item.quantity}pcs</span></p>)} 
                                        <p style={{ fontSize: '18px' }}><span className="font-weight-bold text-primary">Payment ID: </span><span className="font-weight-bold text-dark">{fd.finalData.paymentData}</span> </p><br />
