  ...
  <div className="admissionTable">
    <table style={{width: '1400px'}}>
      <tbody><tr className="first head ">
        ...
        <tr>
          ...
          <td rowSpan={4}>20.10.2022</td>
          <td rowSpan={4}>22.10.2022</td>
    ...
    <table className="first" style={{width: '1400px'}}>
      <tbody><tr>
          ...
          <td rowSpan={8}>2020-2022 </td>
          <td rowSpan={8}>23.08.2022</td>
          <td rowSpan={8}>12.09.2022</td>
    ...
    <table className="first" style={{width: '1400px'}}>
      <tbody><tr>
          ...
          <td rowSpan={4}>2020-2022 </td>
          <td rowSpan={4}>07.02.2022</td>
          <td rowSpan={4}>10.02.2022</td>
    ...
    <table className="first" style={{width: '1400px'}}>
      <tbody><tr>
          ...
          <td rowSpan={4}>2020-2022 </td>
          <td rowSpan={4}>17.08.2022</td>
          <td rowSpan={4}>21.08.2022</td>
    ...
    <table className="first" style={{borderBottom: '5px solid  rgb(124, 32, 32)', width: '1400px'}}>
      <tbody><tr>
          ...
          <td rowSpan={4}>2020-2022 </td>
          <td rowSpan={4}>01.09.2022</td>
          <td rowSpan={4}>19.09.2022</td>
          <td>EEE/ Architecture/ B.Science (CSE)</td>
          <td>20.09.2022<br />21.09.2022</td>
          <td>11am-12.30pm</td>
        </tr>
        <tr>
