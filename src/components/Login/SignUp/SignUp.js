            ...
            <div style={{ position: 'relative', top: '70px' }} className="text-center container">
                ...
                <div className="mt-5 d-flex justify-content-center">
                    <Form onSubmit={handleSubmit} style={{ width: '450px' }}>
                        {errors.name.length > 0 && <p style={{ fontSize: '20px', color: 'blue' }} ><b>{errors.name}</b></p>}
                        {errors.email.length > 0 && <p style={{ fontSize: '20px', color: 'blue' }} ><b>{errors.email}</b></p>}
                        {errors.password.length > 0 && <p style={{ fontSize: '20px', color: 'blue' }} ><b>{errors.password}</b></p>}
                        {errors.confirmPassword.length > 0 && <p style={{ fontSize: '20px', color: 'blue' }} ><b>{errors.confirmPassword}</b></p>}
                        <p style={{ fontSize: '20px', color: 'blue' }} ><b>{msg}</b></p>
